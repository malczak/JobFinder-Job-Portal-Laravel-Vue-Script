                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <ul class="list-unstyled">
                            ...
                            @foreach (App\Models\Category::has('offers')->limit(5)->where('status', 1)->orderBy('name', 'desc')->get() as $cat)
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="list-unstyled">
                            @foreach (App\Models\Category::has('offers')->limit(5)->where('status', 1)->orderBy('name', 'asc')->get() as $cat)
                                <li><a href="{{ route('category.index', [$cat->id,$cat->slug ]) }}">{{ $cat->name }}
                                        ({{ $cat->jobs->count() }})</a></li>
                            @endforeach
                        </ul>
        ...
        <div class="row pt-5 mt-5 text-center">
            <div class="col-md-12">
                <p>
                    ...
                    All Rights Reserved | Made by jobex.com.
