...
<ul>
<li><strong>Development:</strong> Docker</li>
<li><strong>Backend:</strong> Laravel PHP framework</li>
<li><strong>Frontend:</strong> Vue.js JavaScript framework</li>
<li><strong>Database:</strong> MySQL or any supported database system</li>
<li><strong>Other Technologies:</strong> HTML, CSS, JavaScript, AJAX, REST API</li>
</ul>
...
3. Use included Docker configuration to start local development
```bash 
docker compose up --watch
```
(to stop simply kill process in terminal)
4. use you preferred code editor
